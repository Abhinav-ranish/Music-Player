// Update selectors to match miniplayer.html
...
let seek_slider = document.querySelector(".seek-slider"); // Updated name
...
function loadTrack(track_index) {
  ...
  now_playing && (now_playing.textContent = "PLAYING " + (track_index + 1) + " OF " + track_list.length);
